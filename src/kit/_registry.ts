...
export const kitRegistry: KitEntry[] = [
  ...
  // ─── SpacePortfolio additions ─────────────────────────────────────────
  {
    id: "StarsBackground",
    name: "Stars Background",
    category: "3d",
    path: "kit/3d/StarsBackground.tsx",
    source: "SpacePortfolio",
    description: "R3F sphere of stars rotating slowly on X/Y for fixed backdrops.",
  },
  {
    id: "HeroSpaceMedia",
    name: "Hero — Space Media",
    category: "hero",
    path: "kit/heroes/HeroSpaceMedia.tsx",
    source: "SpacePortfolio",
    description: "Two-column hero with gradient headline rows + portrait media.",
  },
  {
    id: "SkillsGrid",
    name: "Skills Grid",
    category: "skills",
    path: "kit/sections/SkillsGrid.tsx",
    source: "SpacePortfolio",
    description: "Two-column bordered skill icon grid with staggered framer reveals.",
  },
  {
    id: "PortraitAboutCard",
    name: "Portrait About Card",
    category: "section",
    path: "kit/sections/PortraitAboutCard.tsx",
    source: "SpacePortfolio",
    description: "Centered portrait + name tag + bio + tagline composition.",
  },
  {
    id: "ProjectGalleryCard",
    name: "Project Gallery Card",
    category: "cards",
    path: "kit/cards/ProjectGalleryCard.tsx",
    source: "SpacePortfolio",
    description: "Rounded image-top project card with title and description.",
  },
  {
    id: "CommunityColumnsFooter",
    name: "Community Columns Footer",
    category: "footer",
    path: "kit/footers/CommunityColumnsFooter.tsx",
    source: "SpacePortfolio",
    description: "Three-column footer (community/social/about) with icon links.",
  },
  {
    id: "PillSocialNavBar",
    name: "Nav — Pill Social",
    category: "navigation",
    path: "kit/navigation/PillSocialNavBar.tsx",
    source: "SpacePortfolio",
    description: "Frosted pill nav with logo, center links and social icons.",
  },

  // ─── Ironhill additions ───────────────────────────────────────────────
  {
    id: "HeroShaderDissolve",
    name: "Hero — Shader Dissolve",
    category: "hero",
    path: "kit/heroes/HeroShaderDissolve.tsx",
    source: "Ironhill",
    description: "GLSL fBm noise overlay dissolves vertically on scroll.",
  },
  {
    id: "ScrollWordFader",
    name: "Scroll Word Fader",
    category: "text",
    path: "kit/text/ScrollWordFader.tsx",
    source: "Ironhill",
    description: "SplitText word-by-word fade tied to ScrollTrigger progress.",
  },
  {
    id: "ScrollParallax",
    name: "Scroll Parallax",
    category: "effects",
    path: "kit/effects/ScrollParallax.tsx",
    source: "Ironhill",
    description: "Generic Y-translate scroll wrapper for decorative elements.",
  },
];
