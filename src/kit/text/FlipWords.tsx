...
/**
 * FlipWords
 * Generalised from Personal-Portfolio/src/components/FlipWords.jsx.
 *
 * Cycles through a list of words with framer-motion's spring + blur exit
 * animation. Great for hero subheadings.
 */
